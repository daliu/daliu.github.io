...
The chr 12q24 cluster (123--124 Mb) is the largest single-Mb GWS hot-spot in the Lam 2019 sumstats but the underlying causal gene is less established than at 10q24. The window borders \emph{NCOR2} (just downstream at $\sim$124.8 Mb) and \emph{SCARB1}; the most credible psychiatric mapping in the broader 12q24 neighborhood involves the \emph{ATXN2/SH2B3/CUX2} cluster well upstream (chr 12: 111--112 Mb), which is outside this 1-Mb window. We do not attempt a definitive top-SNP-to-gene mapping for the 123--124 Mb hot-spot here.
...
VKORC1 -1639 (rs9923231) & CT        & Intermediate warfarin sensitivity; EAS-typical is hom-T (low dose). \emph{Caveat:} dose decisions require IWPC algorithm with CYP2C9, age, BSA, concomitant medications --- single-variant interpretation insufficient \\
